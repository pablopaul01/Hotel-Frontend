                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-xs-12 col-sm-12 mb-3">
                            ...
                            <div className="card text-light card-img-room">
                                ...
                                <div className="card-img-overlay">
                                    <h5 className="card-title card-room">DOBLE TWIN STANDARD</h5>
                                </div>
                            </div>
                            ...
                            <div className="card text-light mt-3 card-img-room">
                                ...
                                <div className="card-img-overlay">
                                    <h5 className="card-title card-room">DOBLE MATRIMONIAL</h5>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                            ...
                            <div className="card text-light card-img-room">
                                ...
                                <div className="card-img-overlay">
                                    <h5 className="card-title card-room">TRIPLE STANDARD</h5>
                                </div>
                            </div>
                            ...
                            <div className="card text-light mt-3 card-img-room">
                                ...
                                <div className="card-img-overlay">
                                    <h5 className="card-title card-room">SUITE</h5>
                                </div>
                            </div>
