...
const CategorieTable = ({ categories, setCategories, getCategories,pending }) => {
        ...
        return (
          ...
          >
            ...
            <button
              ...
              id="t-1"
              onClick={() => {
                deleteCategorie(row._id);
              }}
            >
              <RiDeleteBin6Line className="icon-crud" />
            </button>
          </div>
        );
      },
